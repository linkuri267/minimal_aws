...
#define LOCAL_PORT "23951"

#define MAXBUFLEN 1000

#define FILE_NAME "backendC.txt"
...
int main(int argc, char const *argv[])
{
    ...
    while(1){
	    ...
	    switch(buf_in[0]){
	    	case '1':
	    		output = search(buf_in,myDictionary,'C');
	    		break;
	    	case '2':
	    		output = prefix(buf_in,myPrefixTree,'C');
	    		break;
	    	case '3':
	    		output = suffix(buf_in,mySuffixTree,'C');
	    		break;
	    	otherwise:
        ...
        std::cout << "The ServerC finished sending the output to AWS" << std::endl;
	}
