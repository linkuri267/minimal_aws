...
#define LOCAL_PORT "22951"

#define MAXBUFLEN 1000

#define FILE_NAME "backendB.txt"
...
int main(int argc, char const *argv[])
{
    ...
    while(1){
	    ...
	    switch(buf_in[0]){
	    	case '1':
	    		output = search(buf_in,myDictionary,'B');
	    		break;
	    	case '2':
	    		output = prefix(buf_in,myPrefixTree,'B');
	    		break;
	    	case '3':
	    		output = suffix(buf_in,mySuffixTree,'B');
	    		break;
	    	otherwise:
        ...
        std::cout << "The ServerB finished sending the output to AWS" << std::endl;
